...
public extension CGPoint {
    ...
    func scaledBy(size: CGSize) -> CGPoint {
...
public extension CGPoint {
    func with(x: CGFloat) -> CGPoint { CGPoint(x: x, y: self.y) }
    func with(y: CGFloat) -> CGPoint { CGPoint(x: self.x, y: y) }
}
